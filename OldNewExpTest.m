function OldNewExptest(pID)
    ...
    % pFolder = fullfile('Participants', pID);
    ...
    %----------------------------------------------------------------------
            ...
            for trial = 1:ntrials
                ...
                fprintf(1, 'now reading image %s\n', imgname{filenumber}) % for debugging purposes
